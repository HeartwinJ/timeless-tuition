 ...
 *
 * @checksum - 8a42fde3b054c032c58e385cb4e1f8c479f048275f8923f5c6aaaed45c367329
 * @variables - radius=rounded-lg,accentColor=pink,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-full,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:aria-selected:before:ring-pink-500": true,
    "data-[is-active]:aria-selected:before:ring-inset": true,
    "data-[is-active]:aria-selected:before:ring-offset-pink-100": true,
  },
  ...
  togglebuttons__input: {
    ...
    'group-data-[vertical="false"]/options:group-first/option:!rounded-lg':
      true,
    ...
    'group-data-[vertical="false"]/options:group-[]/option:aria-[pressed="true"]:border-x-pink-500':
      true,
    'group-data-[vertical="false"]/options:group-first/option:aria-[pressed="true"]:border-l-pink-600':
      true,
    'group-data-[vertical="false"]/options:group-last/option:aria-[pressed="true"]:border-r-pink-600':
      true,
    'dark:group-data-[vertical="false"]/options:group-[]/option:aria-[pressed="true"]:border-x-pink-600':
      true,
    'dark:group-data-[vertical="false"]/options:group-first/option:aria-[pressed="true"]:border-l-pink-600':
      true,
    'dark:group-data-[vertical="false"]/options:group-last/option:aria-[pressed="true"]:border-r-pink-600':
      true,
    ...
    'group-data-[vertical="true"]/options:group-[]/option:aria-[pressed="true"]:border-y-pink-500':
      true,
    'group-data-[vertical="true"]/options:group-first/option:aria-[pressed="true"]:border-t-pink-600':
      true,
    'group-data-[vertical="true"]/options:group-last/option:aria-[pressed="true"]:border-b-pink-600':
      true,
    'dark:group-data-[vertical="true"]/options:group-[]/option:aria-[pressed="true"]:border-y-pink-600':
      true,
    'dark:group-data-[vertical="true"]/options:group-first/option:aria-[pressed="true"]:border-t-pink-600':
      true,
    'dark:group-data-[vertical="true"]/options:group-last/option:aria-[pressed="true"]:border-b-pink-600':
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tab": {
    ...
    'group-data-[tab-style="progress"]/wrapper:data-[valid="true"]:data-[visited="true"]:after:bg-pink-600':
      true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid="true"]:data-[visited="true"]:after:bg-pink-600':
      true,
  },
